...
public class ConsoleTableFormatter {
	...
	public ConsoleTableFormatter(String... descriptions) {
		this(descriptions.length, descriptions);
	}
	
	public ConsoleTableFormatter(int columns, String... descriptions) {
	...
	public ConsoleTableFormatter compareWith(Comparator<String[]> c) {
		this.comparator = c;
		return this;
	}

	public ConsoleTableFormatter sortBy(int column) {
		return this.compareWith((o1, o2) -> o1[column].compareTo(o2[column]));
	}

	public ConsoleTableFormatter align(int column, EnumAlignment align) {
		aligns[column] = align;
		return this;
	}

	public ConsoleTableFormatter withSpacing(int spacing) {
	...
	public ConsoleTableFormatter addRow(String... elements) {
	...
	public ConsoleTableFormatter filterBy(int par0, String pattern) {
		this.findex = par0;
		this.filter = pattern;
		return this;
	}

	public ConsoleTableFormatter withUnicode(boolean ucodeEnabled) {
